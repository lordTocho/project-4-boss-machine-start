...
// returns the array of objects( e.g. that the user submits for the response )
...
// retrieves all of the records from the database based on the model type that the user requests
